package com.collect.common.constant;
...
public class UserConstants
{
    ...
    /** 垃圾类型是否唯一的返回结果码 */
    public final static String GAR_TYPE_UNIQUE = "0";
    public final static String GAR_TYPE_NOT_UNIQUE = "1";
    
    /** 垃圾价格是否唯一的返回结果码 */
    public final static String GAR_PRICE_UNIQUE = "0";
    public final static String GAR_PRICE_NOT_UNIQUE = "1";
