package com.collect.framework.aspectj;
...
import com.collect.common.enums.BusinessStatus;
import com.collect.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.collect.common.annotation.Log)")
